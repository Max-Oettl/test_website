...
const copy = {
  de: {
    ...
    hero: {
      eyebrow: "Aktuelles",
      title: "Impulse aus RelTest und der Zuverlässigkeitstechnik.",
    ...
    own: {
      eyebrow: "Von RelTest",
      title: "Beiträge, Webinare und fachliche Entwicklungen",
    ...
    field: {
      ...
      title: "Was die Fachwelt aktuell bewegt",
    ...
    cta: {
      title: "Ein aktuelles Thema betrifft Ihr Projekt?",
  ...
  en: {
    ...
    hero: {
      eyebrow: "News",
      title: "Perspectives from RelTest and reliability engineering.",
    ...
    own: {
      ...
      title: "Articles, webinars and technical developments",
    ...
    field: {
      ...
      title: "Current developments in the field",
    ...
    cta: {
      title: "Does a current development affect your project?",
