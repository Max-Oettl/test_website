...
function NewsDock({
  ...
  return (
    ...
    >
      <summary className="flex h-36 w-[3.25rem] cursor-pointer list-none flex-col items-center justify-between bg-brand-steel-cyan py-4 text-brand-marine shadow-[-10px_12px_26px_rgba(20,36,82,0.14)] transition-colors hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-marine focus-visible:ring-inset [&::-webkit-details-marker]:hidden">
        <span className="font-winnstein-display text-xs font-bold tracking-[0.08em] [writing-mode:vertical-rl] rotate-180">
          {copy.label}
        </span>
        <span className="rotate-180 transition-transform duration-200 motion-reduce:transition-none group-open:rotate-0">
          <ChevronIcon />
        </span>
      </summary>
      ...
      <aside
        ...
        className="absolute top-0 right-full w-[min(20rem,calc(100vw-4rem))] border border-r-0 border-brand-marine/18 border-t-4 border-t-brand-steel-cyan bg-white p-6 text-brand-marine shadow-[-22px_24px_52px_rgba(20,36,82,0.24)] sm:p-7"
      >
