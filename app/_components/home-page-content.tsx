    ...
    supportItems: [
      {
        ...
        icon: "icon-goal-specification.svg",
      },
      {
      ...
      },
      {
        ...
        icon: "icon-evidence-document.svg",
      },
    ],
    projectsTitle: "Beispielhafte Projektverläufe",
    roleLabel: "Unsere Aufgabe",
            ...
            {content.projects.map((project) => (
              ...
              >
                ...
                <div className="grid border-t border-line-soft bg-brand-marine-10/25 sm:grid-cols-[auto_minmax(0,1fr)] sm:items-center">
                  <p className="flex items-center justify-center bg-brand-ink px-6 py-4 text-center text-sm font-bold text-white sm:self-stretch sm:px-8 sm:py-5">
                    {content.resultLabel}
                  </p>
