      ...
      <section className="bg-white px-5 py-14 sm:px-6 sm:py-18 lg:px-8 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[17rem_minmax(0,1fr)] lg:gap-16">
          <aside className="self-start lg:sticky lg:top-28">
            <p className="font-winnstein-display text-xs font-bold tracking-[0.12em] text-brand-marine uppercase">
              {navigationLabel}
            </p>
            ...
            <p className="mt-7 text-xs leading-5 text-brand-marine/75">
            ...
            {sections.map((section, index) => (
              ...
              >
                <div className="grid gap-5 sm:grid-cols-[3.25rem_minmax(0,1fr)] sm:gap-7">
                  <span className="pt-1 font-winnstein-display text-sm font-bold text-brand-marine">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                  <div>
